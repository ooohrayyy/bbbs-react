...
import arrowRightImg from '../../images/svg/arrow-right-black.svg';
import storGalImg from '../../images/stories/gallery.jpg';
    ...
    <>
      <section className="page__section stories">
          ...
          <ul className="tags__list stories__list">
            ...
            <li className="tags__list-item">
              <img
                src={arrowRightImg}
                alt="Стрелка"
                className="next-page__arrow-icon stories__arrow"
              />
            </li>
          </ul>
        </div>
        <img
          className="article__image stories__image"
          src={storImg}
          alt="Алина и Марина"
        />
        ...
        <div className="stories__images-box">
          ...
          />
          <button
            className="stories__arrows stories__arrow-left"
            type="button"
            aria-label="Arrows"
          />
          <img
          ...
          />
          <button
            className="stories__arrows stories__arrow-right"
            type="button"
            aria-label="Arrows"
          />
          <img
